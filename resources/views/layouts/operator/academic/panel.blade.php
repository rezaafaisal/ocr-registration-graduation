        ...
        <aside id="drawer-main" class="bg-white dark:bg-gray-800 shadow transition-colors" tabindex="-1">
            ...
            <nav
                ...
                <ul class="space-y-2 capitalize">
                    <li>
                        <a href="{{ route('operator.academic.dashboard') }}" @class([
                            'flex items-center p-2 text-base font-normal rounded-lg',
                            'dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700' =>
                                request()->url() != route('operator.academic.dashboard'),
                    ...
                    <li>
                        @php
                            $link = route('operator.academic.registrar');
                        @endphp
                        ...
                        <ul id="menu_registrar"
                            ...
                            @foreach (App\Models\Registrar::operator_list_status() as $key => $value)
                                <li>
                                    @php
                                        $link = route("operator.academic.registrar.$key");
                                    @endphp
                                    <a href="{{ $link }}" @class([
                ...
                <ul class="pt-4 mt-4 space-y-2 border-t border-gray-200 dark:border-gray-700 capitalize">
                    <li>
                        @php
                            $link = route('operator.academic.student.index');
                        @endphp
                        <a href="{{ $link }}" @class([
                            'flex items-center p-2 text-base font-normal rounded-lg',
                            'dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700' =>
