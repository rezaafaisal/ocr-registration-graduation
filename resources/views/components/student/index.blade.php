@props([
    ...
    'edit' => function ($item) {
        return route('resources.student.edit', ['student' => $item]);
    },
    'delete' => function ($item) {
        return route('resources.student.delete', ['student' => $item]);
    },
    'deleteAny' => route('resources.student.delete_any'),
])
@section('head')
    @vite('resources/js/components/student/table.js')
@endsection
<div class="grid gap-4">
    <div class="flex gap-2 items-center">
        ...
        @endcan
        @can('deleteAny', App\Models\Student::class)
                                ...
                                @case('status')
                                    <div class="flex flex-col gap-1">
                                        ...
                                        <select id="f_status" name="f_status"
                                            ...
                                            @endif
                                            @foreach (App\Models\Student::list_status() as $key => $value)
